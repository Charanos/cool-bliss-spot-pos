/**
 * Bar glassware in glass and light: a coupe, a rocks glass and a shaker at the edges of the page,
 * with a vignette that keeps the centre clear for content. docs/12-surface-language.md, artwork.
 *
 * Colour comes only from tokens: highlights use --color-glint, liquids the accent and attention
 * roles. Decorative and inert: aria-hidden, no pointer events, no motion.
 */
      ...
      >
        <defs>
          ...
          <linearGradient id="bliss-bar-highlight" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="var(--color-glint)" stopOpacity="0.15" />
            <stop offset="50%" stopColor="var(--color-glint)" stopOpacity="0.0" />
            <stop offset="100%" stopColor="var(--color-glint)" stopOpacity="0.05" />
          </linearGradient>

          {/* Heavy glass body shadow */}
          <linearGradient id="bliss-bar-glass-dark" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="var(--color-ink)" stopOpacity="0.1" />
            <stop offset="100%" stopColor="var(--color-ink)" stopOpacity="0.02" />
          </linearGradient>

          {/* Liquid Teal (Coupe) */}
          <linearGradient id="bliss-bar-liquid-teal-surface" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="var(--color-accent)" stopOpacity="0.3" />
            <stop offset="100%" stopColor="var(--color-accent)" stopOpacity="0.1" />
          </linearGradient>
          <linearGradient id="bliss-bar-liquid-teal-body" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="var(--color-accent)" stopOpacity="0.2" />
            <stop offset="100%" stopColor="var(--color-accent)" stopOpacity="0.02" />
          </linearGradient>

          {/* Liquid Amber (Rocks) */}
          <linearGradient id="bliss-bar-liquid-amber-surface" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="var(--color-attention)" stopOpacity="0.3" />
            <stop offset="100%" stopColor="var(--color-attention)" stopOpacity="0.1" />
          </linearGradient>
          <linearGradient id="bliss-bar-liquid-amber-body" x1="0" y1="0" x2="0" y2="1">
          ...
          {/* Protective Vignette */}
          <radialGradient id="bliss-bar-center-clear" cx="50%" cy="50%" r="65%" fx="50%" fy="50%">
        ...
        <g transform="translate(-100, 480) scale(1.6) rotate(-12, 150, 150)">
          {/* Stem & Base */}
          <path d="M 146 160 L 146 320" stroke="url(#bliss-bar-highlight)" strokeWidth="8" strokeLinecap="round" />
          <path d="M 154 160 L 154 320" stroke="var(--color-ink)" strokeOpacity="0.1" strokeWidth="4" />
          <ellipse cx="150" cy="320" rx="80" ry="12" fill="url(#bliss-bar-glass-dark)" />
          <ellipse cx="150" cy="320" rx="80" ry="12" stroke="url(#bliss-bar-highlight)" strokeWidth="2" />
        ...
        <g transform="translate(1300, 120) scale(1.6) rotate(10, 100, 150)">
          ...
          <g transform="translate(0, 0)">
            ...
            <g style={{ mixBlendMode: 'overlay' }} transform="translate(60, 60)">
              ...
              {/* Left Face */}
              <polygon points="0,15 40,30 40,80 0,65" fill="var(--color-glint)" fillOpacity="0.05" />
              {/* Right Face */}
              <polygon points="40,30 80,15 80,65 40,80" fill="var(--color-glint)" fillOpacity="0.1" />
              {/* Highlight Edges */}
          ...
          <g transform="translate(-30, 320) rotate(-35, 60, 100)">
            ...
            <g transform="rotate(12, 60, 0)">
              ...
              <path d="M 15 -100 C 40 -85, 80 -85, 105 -100" stroke="url(#bliss-bar-highlight)" strokeWidth="3" />
            </g>
          </g>
        </g>

        {/* Central Protective Vignette */}
        <rect width="100%" height="100%" fill="url(#bliss-bar-center-clear)" />
      </svg>
    </div>
  );
}
