...
const BACKDROP = '1572116469696-31de0f17cc34';
          ...
          {!person ? (
            <>
              <header className="relative z-10 flex flex-col items-end text-right">
                ...
                <h1 className="mt-16 font-mono text-title font-medium text-balance text-ink pad:mt-32 pad:text-title-lg tablet:text-heading">Sign in to Console</h1>
